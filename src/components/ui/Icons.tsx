...
export function DrumstickIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M15.45 15.4c-2.13.65-4.3.32-5.7-1.1-2.29-2.27-1.76-6.54.73-9.18C12.87 2.75 16.3 1.67 19 2c.33 2.7-.75 6.13-3.12 8.52-1.1 1.1-2.32 1.85-3.57 2.32" />
      <path d="m13.8 16.26.88-.75 1.98 1.44a1.5 1.5 0 0 1-2.12 2.12l-1.44-1.98.7-.83Z" />
      <path d="m10.84 19.36-.57.55a1.5 1.5 0 0 1-2.12-2.12l.55-.57" />
      <path d="m8.44 17.19.55-.56" />
    </svg>
  )
}
...
export function BreadIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M19 6c0-1.7-3.1-3-7-3S5 4.3 5 6" />
...
export function FriesIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M6 9V3h2v6" />
      <path d="M10 9V2h2v7" />
      <path d="M14 9V3h2v6" />
      <path d="M5 9h12l-1.5 13H6.5L5 9z" />
    </svg>
  )
}

export function RockHandIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
